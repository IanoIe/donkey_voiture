    ...
    <main style="background-color: #73AD48; height: 125px;">
        ...
        <div class="container mt-5">
            ...
            <div class="d-flex gap-2 mt-3">
                <a href="/myAccountIndex.php?action=editMyAccount" class="btn btn-primary">Edit</a>
                <a href="/myAccountIndex.php?action=changePassword" class="btn btn-warning">Change password</a>
